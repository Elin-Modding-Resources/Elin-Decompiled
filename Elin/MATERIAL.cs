...
public class MATERIAL : EClass
{
	...
	public static SourceMaterial.Row sourceSnow => EClass.sources.materials[48];

	public static SourceMaterial.Row sourceIce => EClass.sources.materials[61];

	public static SourceMaterial.Row sourceGold => EClass.sources.materials[12];

	public static SourceMaterial.Row sourceOak => EClass.sources.materials[1];

	public static SourceMaterial.Row sourceWaterSea => EClass.sources.materials[88];
