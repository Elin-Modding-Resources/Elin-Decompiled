...
public class SurvivalManager : EClass
{
	...
	public bool OnMineWreck(Point point)
	{
		...
		bool Next()
		{
			...
			if (searchWreck2 == 20)
			{
				Thing container = ThingGen.CreateParcel(null, ThingGen.CreateRecipe("container_shipping"), ThingGen.CreateRecipe("stonecutter"), ThingGen.CreateRecipe("factory_stone"), ThingGen.CreateRecipe("workbench2"), ThingGen.Create("crystal_earth").SetNum(3));
