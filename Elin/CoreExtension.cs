...
public static class CoreExtension
{
	...
	{
		float num = 0.5f;
		SkinColorProfile skinColorProfile = (dark ? SkinManager.Instance.skinDark.colors : SkinManager.CurrentSkin.colors)._default;
		float num2 = 1f + skinColorProfile.contrast;
		num = ((!(c.r + c.g + c.b > 1.5f)) ? (0.5f - skinColorProfile.strength) : (0.5f + skinColorProfile.strength));
	...
	{
		SkinColorProfile skinColorProfile = (dark ? SkinManager.Instance.skinDark.colors : SkinManager.CurrentSkin.colors)._default;
		return "<color=" + GetFixedColor(funcGood() ? skinColorProfile.textGood : skinColorProfile.textBad, dark).ToHex() + ">" + s + "</color>";
	}
	...
	public static string TagColorGoodBad(this string s, Func<bool> funcGood, Func<bool> funcBad, bool dark = false)
	{
		...
		return "<color=" + GetFixedColor(flag ? skinColorProfile.textGood : skinColorProfile.textBad, dark).ToHex() + ">" + s + "</color>";
	}
